...
def test_is_palindromic():
    ...
    assert is_palindromic(11) == False
...
def represent(n: int) -> list:
    """this function creates a list of the palindromes that add up to n
    args: n a number
    returns: a list of the palindromes which add up to n """
    res = []
    x is is_palindromic == True
    y is is_palindromic == True
    z is is_palindromic == True
    n = (x + y + z)
######################################################################
## test code
