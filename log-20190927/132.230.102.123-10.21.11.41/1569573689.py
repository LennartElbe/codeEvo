...
## Lösung Teil 2. (Tests)
def is_palindromic_test():
    assert(is_palindromic(1001)) == True
    assert(is_palindromic(200)) == False
    assert(is_palindromic(0)) == False
    assert(is_palindromic(7)) == True
######################################################################
...
def gen_palindromic(n: int):
    """This is a generator which generates all numbers smaller or equal than n, which are palindromes.
       The functions is_palindromic is used therefore.
    """
