...
def test_is_palindromic():
    """Tests the funciton is_palindrome."""
    assert is_palindromic(123321) == True
    assert is_palindromic(255) == False
    assert is_palindromic(89899898) == True
######################################################################
...
def gen_palindromic(n: int):
    """Yield all palindromes smaller than or equal to n.
    Args:
        n: an integer
    Returns:
        a generator
