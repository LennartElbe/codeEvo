...
E     File "/private/tmp/blabla.py", line 25
E       """ 
E       x: Int
E       xs: List
E       Diese funktion returnt die werte der liste, welche kleiner als x sind.
E       L = []
E       for i in xs:
E           if x <= i:
E               L.append(i)
...
E   # Lsung Teil 2. (Test)
E   
E   def test_list_filter():
E       assert (list_filter(3, [1,2,3,4,5,6]) == [1,2,3])
E       assert (list_filter(-1, [-2, -1, 0, 1]) == [-2, -1])
E       assert (list_filter(1, [2,3,4,5] == [])
E       assert (list_filter(1, []) == [])
E   ######################################################################
E           
E             
E               
