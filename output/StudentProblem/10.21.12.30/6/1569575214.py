...
>       assert list_filter(3, xs2) == [1, 2, 3, 2.5, 3.5], "Fall: reelle Zahl groesser x enthalten"
E       AssertionError: Fall: reelle Zahl groesser x enthalten
E       assert [1, 2, 3, 2.5] == [1, 2, 3, 2.5, 3.5]
E         Right contains one more item: 3.5
E         Use -v to get the full diff

/private/tmp/blabla.py:35: AssertionError
=========================== short test summary info ============================
FAILED ../../../../../tmp/::test_list_filter - AssertionError: Fall: reelle Z...
============================== 1 failed in 0.05s ===============================
