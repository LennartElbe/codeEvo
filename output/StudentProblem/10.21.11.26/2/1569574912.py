...
E     File "/private/tmp/blabla.py", line 57
E       return [(x,y,z) for x in range(1, n + 1) for y in range(1, n + 1) for z in range (1, n + 1) if (x+y+z == n) and if (str(x,y,z) == str(x,y,z)[::-1])]
E                                                                                                                        ^
